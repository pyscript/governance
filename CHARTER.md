# Charter for the PyScript Organization

This is the organizational charter for the PyScript Organization (the "Organization"). By adding their name to the [STEERING-COMMITTEE.md file](./STEERING-COMMITTEE.md), Steering Committee members agree as follows.
